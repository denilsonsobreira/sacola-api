...
public class SacolaServiceImpl implements SacolaService {
    ...
    public Item incluirItemNaSacola(ItemDto itemDto) {
        ...
        System.out.println(itemDto.getQuantidade());
    ...
    @Override
    public Sacola fecharSacola(Long sacolaId, int formaPagamento) {
        Sacola sacola = verSacola(sacolaId);
        if (sacola.getItens().isEmpty()) {
            throw new RuntimeException("Inclua itens na sacola antes de fecha-la");
        }
        FormaPagamento pagamento = formaPagamento == 0 ? FormaPagamento.DINHEIRO : FormaPagamento.MAQUINETA;
